            ...
            <div className="text-white text-center">
              <div className="mb-4">
                <div className="animate-pulse">
                  <div className="h-1 bg-gradient-to-r from-brown-400 to-orange-500 rounded-full mb-2 animate-pulse"></div>
                  <div className="h-1 bg-gradient-to-r from-brown-400 to-orange-500 rounded-full mb-2 animate-pulse delay-75"></div>
                  <div className="h-1 bg-gradient-to-r from-brown-400 to-orange-500 rounded-full animate-pulse delay-150"></div>
                </div>
              </div>
        ...
        {resultImage && !loading && (
          <div className="absolute bottom-4 right-4">
            <button
              ...
              className="bg-[#ffdb01] hover:bg-brown-500 text-black px-4 py-2 rounded-lg text-sm font-medium transition-colors flex items-center gap-2"
            >
            ...
            {sourceImage ? (
              <div 
                ...
                className={`dashed-orangish-border rounded-xl w-full aspect-[1/1.2] min-h-[200px] ${
                  loading ? 'cursor-not-allowed opacity-50' : 'cursor-pointer hover:border-brown-500'
              ...
              <button 
                ...
                className={`dashed-orangish-border rounded-xl w-full aspect-[1/1.2] flex flex-col items-center justify-center gap-3 py-16 px-4 min-h-[200px] text-gray-600 dark:text-gray-300 transition ${
                  loading 
                    ...
                    : 'cursor-pointer hover:text-gray-900 dark:hover:text-white hover:border-brown-500'
                }`}
              >
