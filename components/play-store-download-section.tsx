          ...
          <div className="flex flex-col md:flex-row">
            ...
            <div className="bg-gradient-to-br from-primary/10 to-secondary/10 p-8 md:w-1/3 flex flex-col items-center text-center">
              <div className="w-24 h-24 bg-primary/20 rounded-2xl flex items-center justify-center mb-4">
                <img src="/images/featured.webp" alt="SuperBear" className="w-20 h-20 rounded-xl" />
              </div>
              <h3 className="text-xl font-bold mb-2">Super Bear Adventures</h3>
              ...
              <div className="flex items-center gap-1 mb-2">
                {[1, 2, 3, 4, 5].map((star) => (
                  <Star key={star} className="w-4 h-4 fill-brown-400 text-brown-400" />
                ))}
            ...
            <div className="p-8 md:w-2/3">
              <div className="flex items-start justify-between mb-6">
                <div>
                  <h2 className="text-2xl font-bold mb-2">Super Bear Adventure Mod APK </h2>
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                ...
                <div className="flex items-center gap-2">
                  <Star className="w-4 h-4 text-brown-500" />
