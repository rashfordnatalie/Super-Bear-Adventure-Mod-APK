...
export function FaceAnalysisToolDemo({ lang = "es" }: FaceAnalysisToolProps) {
  ...
  const getRatingColor = (rating: number) => {
    ...
    if (rating >= 6) return "text-brown-600 dark:text-brown-400"
  ...
  const getProgressColor = (rating: number) => {
    ...
    if (rating >= 6) return "bg-brown-500"
      ...
      {!analysisData && (
        <section className="flex flex-col lg:flex-row gap-8 lg:gap-16 items-center justify-center">
              ...
              {loading && (
                <div className="absolute inset-0 bg-black/60 backdrop-blur-sm rounded-2xl flex flex-col items-center justify-center">
                  ...
                  <div className="absolute inset-0 overflow-hidden rounded-2xl">
                    <div
                      className="absolute left-0 right-0 h-1 bg-gradient-to-r from-transparent via-brown-400 to-transparent shadow-lg shadow-brown-400/50 transition-all duration-75 ease-linear"
                      style={{
                        top: `${scanProgress}%`,
                        opacity: loading ? 1 : 0,
                      }}
                    />
                    <div
                      className="absolute left-0 right-0 h-8 bg-gradient-to-r from-transparent via-brown-400/20 to-transparent transition-all duration-75 ease-linear"
                      style={{
                  ...
                  <div className="text-white text-center space-y-4 z-10">
                    <div className="space-y-2">
                      <Scan className="w-10   mx-auto animate-pulse text-brown-400" />
          ...
          <div className="flex flex-col space-y-6 max-w-md w-full">
            <div className="border-2 border-dashed border-brown-400 dark:border-brown-500 rounded-xl p-8 hover:border-brown-500 dark:hover:border-brown-400 transition-colors bg-white dark:bg-gray-800">
              <div className="text-center space-y-6">
                <div className="mx-auto w-24 h-24 bg-brown-100 dark:bg-brown-900/30 rounded-full flex items-center justify-center">
                  <Upload className="w-12 h-12 text-brown-600 dark:text-brown-400" />
                </div>
                <div>
                  ...
                  <Button
                    ...
                    disabled={loading}
                    className="bg-brown-500 hover:bg-brown-600 dark:bg-brown-600 dark:hover:bg-brown-500 text-black py-3 px-6 rounded-xl font-semibold transition-colors"
                  >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gray-50 dark:bg-gray-800 rounded-xl p-4 border border-gray-200 dark:border-gray-700">
                <h4 className="font-semibold mb-3 text-brown-600 dark:text-brown-400">{t("featureRatings", lang)}</h4>
              ...
              <div className="space-y-3">
                <Button
                  ...
                  variant="outline"
                  className="w-full border-brown-500 dark:border-brown-400 text-brown-600 dark:text-brown-400 hover:bg-brown-500 hover:text-black dark:hover:bg-brown-400 dark:hover:text-black py-3 rounded-xl font-semibold bg-transparent"
                >
                  {t("uploadNew", lang)}
                </Button>
              </div>
            ...
            <div className="lg:col-span-2">
                    ...
                    {Array.from({ length: analysisData.face_count }, (_, i) => (
                      <Button
                        ...
                        className={`px-4 py-2 rounded-lg ${activeFace === i
                          ? "bg-brown-500 text-black hover:bg-brown-600"
              ...
              <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                <TabsList className="grid h-auto w-full grid-cols-4 md:grid-cols-7 bg-gray-100 dark:bg-gray-800 rounded-xl p-1 gap-1">
                  {tabConfig.map(({ value, label, icon: Icon }) => (
                    <TabsTrigger
                      key={value}
                      value={value}
                      className="flex items-center justify-center gap-2 text-xs md:text-sm px-2 py-2  data-[state=active]:bg-brown-500 data-[state=active]:text-black data-[state=active]:shadow-md  data-[state=active]:rounded-[11px]  transition-all duration-200 hover:bg-gray-200 dark:hover:bg-gray-700 text-gray-600 dark:text-gray-300"
                    >
                      ...
                      <div className="relative w-32 h-32">
                        <svg className="w-32 h-32 transform -rotate-90" viewBox="0 0 120 120">
                          ...
                          <circle
                            ...
                            className="text-brown-500 dark:text-brown-400"
                            strokeLinecap="round"
                          />
                        </svg>
                      ...
                      <div className="flex-1">
                        <div className="space-y-4">
                          ...
                          <div className="w-full bg-gray-300 dark:bg-gray-700 rounded-full h-3">
                            <div
                              className="bg-gradient-to-r from-red-500 via-brown-500 to-green-500 h-3 rounded-full transition-all duration-1000"
                ...
                <TabsContent value="eyes" className="mt-6">
                  <div className="bg-gray-50 dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700">
                    <div className="flex items-center gap-4 mb-6">
                      <Eye className="w-8 h-8 text-brown-600 dark:text-brown-400" />
                      <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      {/* Characteristics */}
                      <div>
                        <h4 className="font-semibold mb-4 text-brown-600 dark:text-brown-400">{t("characteristics", lang)}</h4>
                        <div className="space-y-3">
                      ...
                      <div className="space-y-6">
                        <div>
                          <h4 className="font-semibold mb-4 text-brown-600 dark:text-brown-400">{t("measurements", lang)}</h4>
                          <div className="space-y-2">
                        ...
                        <div>
                          <h4 className="font-semibold mb-4 text-brown-600 dark:text-brown-400">{t("ratings", lang)}</h4>
                          <div className="space-y-3">
                ...
                <TabsContent value="nose" className="mt-6">
                  <div className="bg-gray-50 dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700">
                    <div className="flex items-center gap-4 mb-6">
                      <Users className="w-8 h-8 text-brown-600 dark:text-brown-400" />
                      <div>
                ...
                <TabsContent value="lips" className="mt-6">
                  <div className="bg-gray-50 dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700">
                    <div className="flex items-center gap-4 mb-6">
                      <Smile className="w-8 h-8 text-brown-600 dark:text-brown-400" />
                      <div>
                ...
                <TabsContent value="brows" className="mt-6">
                  <div className="bg-gray-50 dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700">
                    <div className="flex items-center gap-4 mb-6">
                      <User className="w-8 h-8 text-brown-600 dark:text-brown-400" />
                      <div>
                ...
                <TabsContent value="shape" className="mt-6">
                  <div className="bg-gray-50 dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700">
                    <div className="flex items-center gap-4 mb-6">
                      <div className="w-24 h-16 bg-gray-200 dark:bg-brown-900/30 rounded-full flex items-center justify-center">
                        <User className="w-8 h-8 text-brown-600 dark:text-brown-400" />
                      </div>
                      <div>
                        <h3 className="text-xl font-bold text-gray-900 dark:text-white">{t("faceShapeAnalysis", lang)} : <span className="text-brown-500">{currentFace.detailed_analysis.face_shape?.translated_shape} </span></h3>
                        <p className="text-gray-600 dark:text-gray-300 text-sm">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div>
                        {/* Characteristics */}
                        <div className="mt-4">
                          <h5 className="font-semibold mb-4 text-brown-600 dark:text-brown-400">{t("characteristics", lang)}</h5>
                          <div className="space-y-2">
                        ...
                        {currentFace.detailed_analysis.face_shape?.recommendations && (
                          <div className="mt-6">
                            <h4 className="font-semibold mb-4 text-brown-600 dark:text-brown-400">{t("styleRecommendations", lang)}</h4>
                      ...
                      {/* Shape Probabilities */}
                      <div>
                        <h4 className="font-semibold mb-4 text-brown-600 dark:text-brown-400">{t("allShapeProbabilities", lang)}</h4>
                        <div className="space-y-3">
                            ...
                            .map(([shape, percentage]) => (
                              <div key={shape} className="space-y-1">
                                <div className="flex justify-between text-sm">
                                  ...
                                  <span className="font-bold text-brown-600 dark:text-brown-400">{percentage}%</span>
                                </div>
                                <div className="w-full bg-gray-300 dark:bg-gray-600 rounded-full h-2">
                                  <div
                                    className="bg-brown-500 dark:bg-brown-400 h-2 rounded-full transition-all duration-500"
                    ...
                    <div className="mt-8">
                      <h4 className="font-semibold mb-4 text-brown-600 dark:text-brown-400">{t("facialMeasurements", lang)}</h4>
                    ...
                    <div className="mt-8">
                      <h4 className="font-semibold mb-4 text-brown-600 dark:text-brown-400">{t("facialProportions", lang)}</h4>
                ...
                <TabsContent value="others" className="mt-6">
                  <div className="bg-gray-50 dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700">
                    <div className="flex items-center gap-4 mb-6">
                      <BarChart3 className="w-8 h-8 text-brown-600 dark:text-brown-400" />
                      <h3 className="text-xl font-bold text-gray-900 dark:text-white">{t("analysisOverview", lang)}</h3>
                    </div>

                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
                        <h4 className="font-semibold mb-4 text-brown-600 dark:text-brown-400">{t("topFeatures", lang)}</h4>
                        <div className="space-y-3">
                      ...
                      <div>
                        <h4 className="font-semibold mb-4 text-brown-600 dark:text-brown-400">{t("improvementAreas", lang)}</h4>
                        <div className="space-y-3">
                          {Object.entries(currentFace.feature_ratings)
                            .sort(([, a], [, b]) => a - b)
                            .slice(0, 3)
