        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center space-x-2 mb-4">
              <img src="/images/logo.webp" width={171} alt="Super Bear Adventures Logo" />
            </div>
  ...
  Download Super Bear Adventure Mod APK with Mod Menu, God Mode & all regions unlocked for unlimited coins, skins, health & fun all for free.
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
               ...
               <li>
                <Link href="/terms-and-conditions" className="hover:text-primary transition-colors text-muted-foreground">
    ...
    © {new Date().getFullYear()} Super Bear Adventure Mod APK . All rights reserved. <br></br><i>This site is not affiliated with the official Super Bear Adventure developers.</i>
  </p>
        </div>
      </div>
    </footer>
