...
export async function generateMetadata({ params }: BlogPostPageProps): Promise<Metadata> {
  ...
  return {
    title: `${decodedTitle}`,
    description,
    keywords: post.tags?.map((tag) => decode(tag.name)).join(", ") || "SuperBear",
    alternates: {
      canonical: `https://superbearadv.com/blog/${post.slug}`,
      languages: {
        en: `https://superbearadv.com/blog/${post.slug}`,

        ...(post.languages?.translations?.id && {
          id: `https://superbearadv.com/id/blog/${post.languages.translations.id.slug}`,
        }),
      },
    },
    openGraph: {
      ...
      description,
      type: "article",
      url: `https://superbearadv.com/blog/${post.slug}`,
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 mt-8">
            ...
            <div className="lg:col-span-3">
              ...
              <div
                ...
                [&_h2]:bg-brown-100 [&_h2]:dark:bg-brown-900/20 [&_h2]:border-l-4 [&_h2]:border-brown-500 [&_h2]:pl-4 [&_h2]:py-3 [&_h2]:rounded-r-lg [&_h2]:font-bold [&_h2]:text-xl [&_h2]:text-gray-900 [&_h2]:dark:text-white [&_h2]:my-6
                [&_h3]:border-b-2 [&_h3]:border-brown-500 [&_h3]:pb-2 [&_h3]:font-bold [&_h3]:text-lg [&_h3]:text-gray-900 [&_h3]:dark:text-white [&_h3]:my-4
                [&_h4]:bg-brown-100 [&_h4]:dark:bg-brown-900/20 [&_h4]:border-l-4 [&_h4]:border-brown-500 [&_h4]:pl-4 [&_h4]:py-2 [&_h4]:font-semibold [&_h4]:text-base [&_h4]:text-gray-900 [&_h4]:dark:text-white [&_h4]:my-3"
              >
                <BlogPost post={post} />
              </div>
            </div>
            ...
            <div className="lg:col-span-1">
              <div className="sticky top-8 space-y-8">
                ...
                {relatedPosts.length > 0 && (
                 <section>
                 <p className="text-xl font-bold text-gray-900 dark:text-white mb-6 bg-brown-100 dark:bg-brown-900/20 border-l-4 border-brown-500 pl-4 py-3 rounded-r-lg">
                   Related Posts
                 </p>
                ...
                {/* <section>
                  <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-6 bg-brown-100 dark:bg-brown-900/20 border-l-4 border-brown-500 pl-4 py-3 rounded-r-lg">
                    Latest Posts
                  </h2>
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              mainEntityOfPage: {
                "@type": "WebPage",
                "@id": `https://superbearadv.com/blog/${post.slug}`,
              },
              headline: decode(post.title),
              description: decode(post.excerpt).replace(/<[^>]*>/g, "").substring(0, 160),
              image: post.featured_image || "https://superbearadv.com/logo.png",
              author: {
                "@type": "Organization",
                name: "SuperBear",
              ...
              publisher: {
                ...
                logo: {
                  "@type": "ImageObject",
                  url: "https://superbearadv.com/logo.png",
                },
              },
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            headline: decode(post.title),
            description: decode(post.excerpt).replace(/<[^>]*>/g, "").substring(0, 160),
            image: post.featured_image || "https://superbearadv.com/og-image.jpg",
            author: {
              "@type": "Organization",
              name: "SuperBear",
            },
