...
export async function GET() {
  try {
    ...
    const baseUrl = "https://superbearadv.com"
    ...
    const staticPages = [
      ...
      { url: `${baseUrl}/contact-us`, priority: "1.00" }, 
      { url: `${baseUrl}/privacy`, priority: "1.00" }, 
      { url: `${baseUrl}/terms-and-conditions`, priority: "1.00" }, 
